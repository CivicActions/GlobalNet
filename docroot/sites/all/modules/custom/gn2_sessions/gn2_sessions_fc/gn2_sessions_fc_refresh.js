(function ($, Drupal, window, document, undefined) {
  ...
  $(document).ajaxStop(function () {
    ...
    level1FieldsetClasses = document.getElementsByClassName("group-level1");
    ...
    if (level1FieldsetClasses.length) {
      ...
      level1ButtonsClasses = document.querySelectorAll(".group-level1 > .fieldset-wrapper > .sessions-buttons-wrap");
      // If there are any, loop through them, giving each a unique ID value.
    ...
    if (child != null) {
      ...
      // Scroll to last created / edited session.
      var scrollTo;
