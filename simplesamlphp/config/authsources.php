...
$config = array(
    ...
    'drupal-sandbox' => array('drupalauth:External',

      'drupalroot' => '/var/www/docroot',
      'debug' => true,
      'drupal_logout_url' => '/user/logout',
      'drupal_login_url' => '/user',

      // Attribute mapping from Drupal
      'attributes' => array(
        array('drupaluservar' => 'uid', 'callit' => 'uid'),
        array('drupaluservar' => 'name', 'callit' => 'cn'),
        array('drupaluservar' => 'mail', 'callit' => 'mail'),
        array('drupaluservar' => 'field_name_first',  'callit' => 'givenName'),
        array('drupaluservar' => 'field_name_last',   'callit' => 'sn'),
        array('drupaluservar' => 'field_user_organization','callit' => 'ou'),
        array('drupaluservar' => 'roles','callit' => 'roles'),
      ),
    ),

    'drupal-dev' => array('drupalauth:External',

      'drupalroot' => '/var/www/dev/docroot',
      'debug' => true,
      'drupal_logout_url' => '/user/logout',
      'drupal_login_url' => '/user',
    ...
    'drupal-stage' => array('drupalauth:External',

      'drupalroot' => '/var/www/stage/docroot',
      'debug' => true,
      'drupal_logout_url' => '/user/logout',
      'drupal_login_url' => '/user',
    ...
    'drupal-prod' => array('drupalauth:External',

      'drupalroot' => '/var/www/prod/docroot',
      'debug' => true,
      'drupal_logout_url' => '/user/logout',
      'drupal_login_url' => '/user',
