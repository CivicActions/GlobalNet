...
Feature: content.support.feature
  ...
  @RD-4000 @ettest11
#    =====================================
#    CAPTCHA is causing this test to fail
#    =====================================
...
#    Then I should see the CSS selector "input[id='edit-gn2-support-desk-jira-submit']"
  ...
  @RD-4043
  Scenario: non-orgmanager/admin users should not be able to whitelist IPs
    Given I am an anonymous user
    Then I go to "node/add/support?gid=16"
    Then I should not see the text "Whitelist and IP address"

  @RD-4043
  Scenario: Org Managers should be able to whitelist IPs
    And I am logged in as "uadmin" with password "civicactions"
    Then I go to "node/add/support?gid=16"
    And I select the radio button with the id "edit-field-support-category-und-7"
    And I fill in "edit-field-ip-address-range-und-0-value" with "abc123"
    And I press the "Publish" button
    Then I should see the text "Invalid IP range or address."
    And I fill in "edit-field-ip-address-range-und-0-value" with "10.10.10.10/20"
    And I fill in "edit-field-description-und-0-value" with "Test text"
    And I press the "Publish" button
    Then I should see the text "Thank you. Your request for technical support has been submitted."
